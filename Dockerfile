...
RUN apt-get update && \
    ...
    mkdir /usr/local/share/zsh/zsh-completions && \
    curl -s -L https://github.com/zsh-users/zsh-completions/archive/refs/heads/master.zip | \
          bsdtar zxf - -C /usr/local/share/zsh/zsh-completions --strip-components 1 && \
